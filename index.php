...
<html lang="ja">
  <head>
    ...
    <script
      async
      src="https://www.googletagmanager.com/gtag/js?id=G-Z3TMZ3DZJQ"
    ></script>
    <script>
      ...
      <section class="application container mt-5">
        ...
        <div class="schedule-group mt-3">
          ...
          >
            ...
            >
              <span class="label"
                >第22回 10月27日(月) 例会お申し込みフォーム</span
              >
            </a>
          </div>
        ...
        >
          ...
          >
            <span class="label"
              >第23回 11月24日(月) 例会お申し込みフォーム</span
            >
          </a>
        </div> -->
        ...
        >
          ...
          >
            <span class="label"
              >第24回 12月22日(月) 例会お申し込みフォーム</span
            >
          </a>
        </div> -->
        </div>
              ...
              <div class="about-text">
                ...
                <table class="meeting-table">
                  <tbody>
                    ...
                    <tr>
                      <th scope="row">
                        <span class="label">場　　所</span
                        ><span class="colon">：</span>
                      </th>
                      <td>
                        〒222-0033<br />
                        <span class="meeting-table-place"
                          >神奈川県横浜市港北区新横浜3-18-8</span
                        ><br />
                        アルカンシエル横浜
                      </td>
                    </tr>
          ...
          <form id="contact-form" action="confirm.php" method="post">
            <div class="form-group">
              <label for="memberType"
                >会員区分:　<span class="any">任意</span></label
              >
            ...
            <div class="form-group">
              <label for="registrationLocation"
                >登録会場:　<span class="any">任意</span></label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label for="companyName"
                >会社名:　<span class="any">任意</span></label
              >
